#ifndef _POLYSTAR_POLYHEDRON_FACES_HPP_
#define _POLYSTAR_POLYHEDRON_FACES_HPP_
...
//    template<class T, template<class> class A, std::enable_if_t<isArray<T,A>>* = nullptr> // this worked before moving isArray into polystar::lattice::
//    template<class T, template<class> class A, std::enable_if_t<isArray<T,A>>* = nullptr> // doesn't work
    template<class T, template<class> class A> // hopefully doesn't capture anything non-polystar::Array based
